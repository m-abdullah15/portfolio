  ...
  const projects = [
    {
      ...
      features: ["Disease Detection","Machine Learning Integration", "User Dashboard", "Scan History", "Disease Solutions", "Image Analysis"],
    ...
    },
    {
      ...
      features: ["User Authentication", "Property Search & Filtering", "Inquiry Management", "Listing Management"],
    ...
    },
    {
      ...
      features: ["Real-time Messaging", "User Registration", "Group Chat", "WebSocket Integration"],
            ...
            <div className="space-y-6">
              <div className={`p-8 rounded-2xl transform hover:scale-105 transition-all duration-300 ${
                ...
                <p className={`leading-relaxed ${
                  ...
                  I specialize in building complete web solutions, from front-end user interfaces to back-end. 
                  My expertise spans across modern technologies including Web development, and machine learning integration.
                </p>
              </div>
